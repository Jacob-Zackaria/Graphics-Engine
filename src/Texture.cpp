...
Texture::Name Texture::getName() const
{
	return this->name;
}

void Texture::setName(Texture::Name inName)
{
	this->name = inName;
}

//-----links----
void Texture::setNext(Texture* newNext)
{
	this->pNext = newNext;
}

void Texture::setPrev(Texture* newPrev)
{
	this->pPrev = newPrev;
}

Texture* Texture::getNext() const
{
	return (this->pNext);
}

Texture* Texture::getPrev() const
{
	return (this->pPrev);
}