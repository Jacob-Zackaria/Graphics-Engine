...
ShaderColorLight::ShaderColorLight(ID3D11Device* dev, ID3D11DeviceContext* devcon)
	: DirLightData(nullptr), PointLightData(nullptr), SpotLightData(nullptr), ShaderBase(dev, devcon, L"../Assets/Shaders/ColorLight.hlsl")
{
...
void ShaderColorLight::AddFogParameters(const float fogStart, const float fogRange, const Vect fogColor)
{
...
void ShaderColorLight::UpdateAllLightPositions(const Matrix& m)
{
	DirectionalLight* pDLink = DirLightData;
...
void ShaderColorLight::AddDirectionalLight(DirectionalLight::Name newName, DirectionalLight& newLight)
{
...
void ShaderColorLight::AddPointLight(PointLight::Name newName, PointLight& newLight)
{
	newLight.SetName(newName);
...
void ShaderColorLight::AddSpotLight(SpotLight::Name newName, SpotLight& newLight)
{
	newLight.SetName(newName);
...
SpotLight* ShaderColorLight::FindSpotLight(SpotLight::Name newName)
{
	SpotLight* pSLink = SpotLightData;
...
PointLight* ShaderColorLight::FindPointLight(PointLight::Name newName)
{
...
DirectionalLight* ShaderColorLight::FindDirectionalLight(DirectionalLight::Name newName)
{
...
void ShaderColorLight::privAddToFront(LightType* node, LightType*& head)
{
	assert(node != 0);
...
void ShaderColorLight::privRemove(LightType* pNode, LightType*& poHead)
{
	assert(pNode);
